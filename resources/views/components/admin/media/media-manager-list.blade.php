    ...
    @forelse ($items as $item)
      <div class="gallery_div_photo" data-draggable data-id="{{ $item->id }}">
        ...
        <div class="__img">
          ...
          @elseif($item->photo)
            <img src="{{ Storage::disk($disk)->url($item->photo ) }}" class="NeedStyle"/>
          @endif
        </div>
      </div>
    @empty

      <div class="alert alert-danger text-center font-bold" style="width: 100%!important; margin-top: 30px!important;">
